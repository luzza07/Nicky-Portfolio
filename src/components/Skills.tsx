...
import { Code2, Database, Globe, Brain, GitBranch, Settings, Zap } from 'lucide-react';
              ...
              <div className="relative p-6">
                ...
                <div className="space-y-2">
                  {category.skills.map((skill, skillIndex) => (
                    ...
                    >
                      <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${category.color} opacity-60 group-hover/skill:opacity-100 transition-opacity duration-200`} />
                ...
                <div className="flex justify-end mt-4">
                  <span className={`px-3 py-1 text-xs font-medium text-white bg-gradient-to-r ${category.color} rounded-full shadow-sm`}>
